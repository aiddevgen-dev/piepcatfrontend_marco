...
export default function SignupPage() {
  ...
  items-center justify-center text-white font-bold instrument italic text-xl">
                ...
                <p className="text-muted-foreground mb-8">Create your account and start building with AI
                    voice.</p>

                {/* Google OAuth */}
                <Button variant="outline" className="w-full mb-4 h-12" onClick={() => signIn("google", { callbackUrl: "/dashboard" })} >
  ...
  14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 
  ...
  hover:text-foreground"
                        ...
                        <p className="text-xs text-muted-foreground mt-1">Must be at least 8 characters with a
                            number and symbol</p>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Label htmlFor="terms" className="text-sm font-normal">
                            I agree to the <Link href="#" className="text-primary hover:underline">Terms of
                                Service</Link> and <Link href="#" className="text-primary hover:underline">Privacy Policy</Link>
                        </Label>
                    </div>

                    {/* Submit */}
                    <Button type="submit" disabled={loading} className="w-full h-12 bg-green-500 hover:bg-green-600 text-white">
