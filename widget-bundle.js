...
Url: ${Dn(e3)}`), true;
  ...
  var Ha = (function() {
    function r2(e2) {
      ...
      if (t(this, r2), o2 = this, c3 = a(c3 = r2), u(i3 = s(o2, ja() ? Reflect.construct(c3, l2 || [], a(o2).constructor) : c3.apply(o2, l2)), "startListeningForDeviceChanges", (function() {
        ...
        i3.stopScreenShare();
      })), i3.strictMode = void 0 === h3.strictMode || h3.strictMode, i3.allowMultipleCallInstances = null !== (n2 = h3.allowMultipleCallInstances) && void 0 !== n2 && n2, Object.keys(La).length && (i3._logDuplicateInstanceAttempt(), !i3.allowMultipleCallInstances)) {
    ...
    return l(r2, b), o(r2, [{ key: "destroy", value: (ee2 = p((function* () {
      ...
      return nc(), this.sendMessageToCallMachine({ action: "load-css", cssFile: this.absoluteUrl(n2), bodyClass: t2, cssText: r3 }), this;
      ...
      if (ec(this._callObjectMode, "updateWaitingParticipant()"), Qa(this._callState, "updateWaitingParticipant()"), "string" != typeof t2 || "object" !== n(r3)) throw new Error("updateWaitingParticipant() must take an id string and a updates object");
      ...
      var t2 = this;
      return nc(), sc(e2) ? e2.video || e2.audio ? (ac(e2, this.properties.dailyConfig, this._sharedTracks), this._callObjectMode && !this._callMachineInitialized ? (this._updatePreloadCacheInputSettings(e2, true), this._getInputSettings()) : new Promise((function(n2, r3) {
      ...
      return nc(), Qa(this._callState, "startCustomTrack()"), this.validateCustomTrack(t2.track, t2.mode, t2.trackName), new Promise((function(n2, r3) {
      ...
      if (nc(), void 0 !== i3 && (n2 = i3), void 0 !== o2 && (r3 = o2), "boolean" == typeof n2 && (this._setAllowLocalAudio(n2), n2 = void 0), "boolean" == typeof r3 && (this._setAllowLocalVideo(r3), r3 = void 0), !n2 && !r3) return yield this.getInputDevices();
      var s2 = {};
      ...
      return this.validateProperties(t2), this.properties = Aa(Aa({}, this.properties), t2), new Promise((function(t3, n2) {
        e2._preloadCache.inputSettings = e2._prepInputSettingsForSharing(e2._inputSettings, false), e2.sendMessageToCallMachine({ action: "daily-method-preauth", properties: Ga(e2.properties, e2.callClientId), preloadCache: Ga(e2._preloadCache, e2.callClientId) }, (function(r3) {
      ...
      return void 0 !== t2.showLocalVideo && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!t2.showLocalVideo), void 0 !== t2.showParticipantsBar && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!t2.showParticipantsBar), this._callState === oi || this._callState === ii ? (console.warn("already joined meeting, call leave() before joining again"), void this.updateIsPreparingToJoin(false)) : (this._updateCallState(ii, false), this.emitDailyJSEvent({ action: Wi }), this._preloadCache.inputSettings = this._prepInputSettingsForSharing(this._inputSettings || {}, false), this.sendMessageToCallMachine({ action: "join-meeting", properties: Ga(this.properties, this.callClientId), preloadCache: Ga(this._preloadCache, this.callClientId) }), new Promise((function(t3, r3) {
      ...
      var t2 = this;
      return Qa(this._callState, "stopDialOut()"), new Promise((function(n2, r3) {
      ...
      return e2.useSipRefer = false, mc(e2, "sipCallTransfer"), new Promise((function(n2, r3) {
      ...
      return e2.useSipRefer = true, mc(e2, "sipRefer"), new Promise((function(n2, r3) {
        t2.sendMessageToCallMachine(Aa({ action: ns }, e2), (function(e3) {
          e3.error ? r3(e3.error) : n2(e3);
        }));
      }));
      ...
      var t2 = this;
      return tc(this._callObjectMode, "setTheme()"), new Promise((function(n2, r3) {
        try {
      ...
      var t2 = this;
      return nc(), Qa(this._callState, "setNetworkTopology()"), new Promise((function(n2, r3) {
      ...
      if (e2 !== this._callState || t2 !== this._isPreparingToJoin) {
        ...
        var o2 = Ka(n2, r3), s2 = Ka(this._callState, this._isPreparingToJoin);
  ...
  function gc(e2, t2) {
    ...
    switch (n(t2)) {
      ...
      case "object":
        if ("object" !== n(e2)) return false;
        for (var r2 in e2) if (!gc(e2[r2], t2[r2])) return false;
        return true;
      default:
        return false;
    }
...
`;
  ...
  var $22ece045290c996a$export$c95c65abc5f47125 = (
    ...
    (function(_super) {
      ...
      function DailyMediaManager(enablePlayer, enableRecording, onTrackStartedCallback, onTrackStoppedCallback, recorderChunkSize, recorderSampleRate, playerSampleRate) {
        ...
        _this._daily = (_a2 = (0, Ha).getCallInstance()) !== null && _a2 !== void 0 ? _a2 : (0, Ha).createCallObject();
  ...
  // widget-entry.js
  window.PipecatClient = $364c127d152b1085$export$8f7f86a77535f7a3;
  window.RTVIEvent = $c1b4da4af54f4fa1$export$6b4624d233c61fcb;
  window.WebSocketTransport = $7f42eda74f1b1632$export$de21836fc42c6f9c;
})();
